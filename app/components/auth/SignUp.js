...
const SignUp = () => {
    return (
        <>
            <div className='signin_component bg-white max-w-full w-[340px] rounded-2xl p-4'>
                <h2 className='p-1 text-center'>Sign up</h2>
                ...
                <form className='flex flex-col gap-2'>
                    ...
                    <div className='cta w-full mt-2'>
                        <button className='button_primary full_width' formAction={signup}>Continue ⟶</button>

                        <p className='text-heading_secondary text-center text-sm mt-4'>{" "}
                        <Link href='/login' className='text-primary-500 text-sm'>or sign in instead</Link></p>
                    </div>
                </form>
            </div>
